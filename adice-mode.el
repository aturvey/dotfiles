...
;;
;; SETTING KEY-BINDINGS: you can customise keys just within adice, for
;; example to toggle comments with the Meta-C key (done by default):
;; (define-key adice-mode-map "\M-c" 'adice-toggle-comment)
;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;
...
(defvar adice-tab-width 2 "*TAB stop width in adice.")
...
;; (if (string-match "XEmacs" emacs-version) (font-lock-mode 1) (global-font-lock-mode t) )
;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
(if (string-match "XEmacs" emacs-version) (setq adice-file-finder 'locate-file)
...
;; keybinding stuff
(defvar adice-mode-map () "Keymap used in Adice modes.")
(if adice-mode-map () (setq adice-mode-map (make-sparse-keymap)))
(define-key adice-mode-map "\t"    'adice-tab)
(define-key adice-mode-map "\M-;"  'adice-toggle-comment)
(define-key adice-mode-map [(f4)]  'adice-toggle-comment)
;(define-key adice-mode-map [(f9)]  'adice-current-word-help)
(define-key adice-mode-map "\C-cf" 'adice-find-file-current-word)
...
(add-to-list 'auto-mode-alist '("\\.sim$"     . adice-mode))
